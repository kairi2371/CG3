...
IDxcBlob* CompileShader(
	...
	LPCWSTR arguments[] = {
	    ...
	    L"-E",
	    L"main", // eエントリーポイントの指定、基本的にmain以外にはしない
	    L"-T",
...
ID3D12Resource* CreateBufferResource(ID3D12Device* device, size_t sizeInBytes) {
	...
	vertexResourceDesc.Dimension =
	    D3D12_RESOURCE_DIMENSION_BUFFER; // リソースのサイズ、今回はVector4を３頂点分
	...
	HRESULT deb;
	deb = device->CreateCommittedResource(
...
// ID3D12DescriptorHeap* CreateDescriptorHeap(
//	ID3D12Device* device, D3D12_DESCRIPTOR_HEAP_TYPE heapType, UINT numDescriptors, bool
//shaderVisible)
//{
//
// }
